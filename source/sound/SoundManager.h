...
public:
    ...
    FMOD::Channel * createNewChannel3D(int soundID, bool paused, FMOD_VECTOR position, FMOD_VECTOR velocity);
...
protected:
    ...
    FMOD::Sound * createSound(const QString & fileName, bool is3D, bool isLoop);
